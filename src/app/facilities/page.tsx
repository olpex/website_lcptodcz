        ...
        <div className="container">
          <div className={styles.heroGrid}>
            <div>
              ...
              <p>
                Розділ перенесено зі старого сайту й переформатовано так, щоб швидко показати масштаб,
                партнерів і практичну логіку навчання.
              </p>
            </div>
      ...
      <section className={styles.note}>
        <div className="container">
          <div className={styles.noteBox}>
            ...
            <p>
              На старому сайті також зазначено, що центр має домовленість із Львівським професійним коледжем
              готельно-туристичного та ресторанного сервісу щодо місць у хостелі неподалік від центру.
            </p>
